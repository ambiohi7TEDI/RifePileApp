...
import 'select_one_model.dart';
export 'select_one_model.dart';

class SelectOneWidget extends StatefulWidget {
  const SelectOneWidget({Key? key}) : super(key: key);
...
class _SelectOneWidgetState extends State<SelectOneWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectOneModel());
  }
