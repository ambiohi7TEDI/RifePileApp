                        ...
                        children: [
                            ...
                            child: StreamBuilder<List<ReviewsRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ReviewsRecord>
                                    ...
                                    snapshot.data!;
                                return Text(
                                  '(⭐${functions.getAverageRating(timestampTextReviewsRecordList.map((e) => e.rating).toList()).toString()})${timestampTextReviewsRecordList.length.toString()}reviews',
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 8.0, 5.0, 8.0),
                            child: Text(
                              restaurantDetailsRestaurantsRecord.category,
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 8.0, 0.0, 8.0),
                            child: Text(
                              'Open Until- ${dateTimeFormat('jm', restaurantDetailsRestaurantsRecord.close)}',
                              style: FlutterFlowTheme.of(context)
                                  .titleMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
