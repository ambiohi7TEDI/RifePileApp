...
import 'destination_map_model.dart';
export 'destination_map_model.dart';

class DestinationMapWidget extends StatefulWidget {
  const DestinationMapWidget({Key? key}) : super(key: key);

  @override
  _DestinationMapWidgetState createState() => _DestinationMapWidgetState();
}

class _DestinationMapWidgetState extends State<DestinationMapWidget>
    with TickerProviderStateMixin {
  late DestinationMapModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DestinationMapModel());
