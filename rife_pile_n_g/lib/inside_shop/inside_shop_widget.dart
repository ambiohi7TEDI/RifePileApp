...
import 'inside_shop_model.dart';
export 'inside_shop_model.dart';

class InsideShopWidget extends StatefulWidget {
  const InsideShopWidget({Key? key}) : super(key: key);

  @override
  _InsideShopWidgetState createState() => _InsideShopWidgetState();
}

class _InsideShopWidgetState extends State<InsideShopWidget>
    with TickerProviderStateMixin {
  late InsideShopModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InsideShopModel());
